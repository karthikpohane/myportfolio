      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            ...
            key={id} // Using 'id' as a unique key
          >
            <PinContainer title={link} href={link}>
              <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[50vh] h-[30vh] mb-1">
                ...
                <img src={img} alt={title} className="z-10 absolute bottom-0 object-cover w-full h-full" />
              </div>
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center space-x-2">
                  {iconLists.map((icon, index) => (
                    <div
                      key={index} // Using index as key for icon items
